...
// Minimal table primitives. Table wraps in a horizontal-scroll container so wide
// tables never break the page layout on small screens.
...
export function TH({ className, ...props }: React.ThHTMLAttributes<HTMLTableCellElement>) {
  return <th className={cn("px-3 py-2.5", className)} {...props} />;
}
